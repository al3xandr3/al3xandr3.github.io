...
See that the black line ($\lambda=0$) is the more tightly fit to the crosses points spread, and as we increase the lambda values it becomes more loose(and more generalized).
