...
[[http://openclassroom.stanford.edu/MainFolder/DocumentPage.php?course=MachineLearning&doc=exercises/ex5/ex5.html][Exercise 5.2]] Improves the Logistic Regression implementation done in [[http://al3xandr3.github.com/2011/03/16/ml-ex4.html][Exercise 4]] by adding a regularization parameter that reduces the problem of over-fitting. We will be using Newton's Method.
...
#+begin_src R :session R :results graphics :file /my/al3xandr3.github.com/img/ml-ex52-data.png
# linear regression
# load the data
...
#+results:
[[file:/my/al3xandr3.github.com/img/ml-ex52-data.png]]

[[http://al3xandr3.github.com/img/ml-ex52-data.png]]

The idea is to create a mathematical model, that separates the circles from the crosses in the plot above. And that will then allow to predict, for a new u and v value, the probability of being a cross.
...
The idea of the regularization is to loosen up the tight fit, and obtain a more generalized fit.
...
#+begin_src R :session R :results graphics :file /my/al3xandr3.github.com/img/ml-ex52-j.png
# check that is converging correctly
plot(jiter, xlab="iterations", ylab="cost J")
#+end_src

#+results:
[[file:/my/al3xandr3.github.com/img/ml-ex52-j.png]]
...
#+begin_src R :session R :results graphics :file /my/al3xandr3.github.com/img/ml-ex52-fit.png
...
#+results:
[[file:/my/al3xandr3.github.com/img/ml-ex52-fit.png]]

[[http://al3xandr3.github.com/img/ml-ex52-fit.png]]

See that the black one is the more tightly fit to the crosses $\lambda=0$, and as we increase Lambda values it becomes more loose(and more generalized).
