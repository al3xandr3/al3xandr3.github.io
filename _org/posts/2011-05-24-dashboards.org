...
Coded in ruby, it aggregates data from different sources, and then outputs to an html file with the full dashboard.
...
Placed on github the code i use as the base to build the dashboards, find it here: https://github.com/al3xandr3/Dashboard
