...
Its the first iteration, where mostly all data is displayed as is, next iteration could enrich the data further with: 
 ...
 - More relative change plots, like the [[http://vis.stanford.edu/protovis/ex/index-chart.html][protovis index-chart]] are very useful, even when they are not dynamic, have one on the dashboard above.
...
Outputs the javascript and html of a chart.
