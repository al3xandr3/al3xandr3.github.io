...
[[http://openclassroom.stanford.edu/MainFolder/DocumentPage.php?course=MachineLearning&doc=exercises/ex4/ex4.html][Exercise 4]] is all about implementing Logistic Regression using Newton's Method, on a classification problem.
...
- Thanks for Tal Galili patience in adding my blog into the [[http://www.r-bloggers.com/][R-bloggers.com]] list. [[http://www.r-bloggers.com/][Go have a peek, R-bloggers]] is a great source of R information.
