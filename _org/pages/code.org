...
A framework for building up html interactive dashboards. Contains implementation of both simple & multivariate regression for visualizing trends, fetching email attachments/content as data sources, also allows for posting the html dashboard output onto a confluence wiki page.
