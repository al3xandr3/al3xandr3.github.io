...
tags:
  ...
  - project
  - data
excerpt: "Implementing Logistic Regression using Newton's Method, on a classification problem"
---
...
![/assets/images/ml-ex4-plotdata.png][3]
...
![/assets/images/ml-ex4-fit.png][6]
...
* Thanks to Andrew Ng and [OpenClassRoom][8] for the great lessons. 
   ...
   [3]: /assets/images/ml-ex4-plotdata.png
   [4]: http://en.wikipedia.org/wiki/File:NewtonIteration_Ani.gif
   [5]: /assets/images/ml-ex4-j.png
   [6]: /assets/images/ml-ex4-fit.png
