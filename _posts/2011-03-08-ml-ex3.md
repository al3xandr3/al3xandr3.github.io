...
tags:
  ...
  - project
  - data
excerpt: "Implementation using the normal equations instead of the gradient descent algorithm"
---
...
![/assets/images/ml-ex3-alpha.png][3]
...
- Thanks to Andrew Ng and [OpenClassRoom][5] for the great lessons. 
   ...
   [2]: http://al3xandr3.github.io/2011/02/24/ml-ex2-linear-regression.html
   [3]: /assets/images/ml-ex3-alpha.png
