...
Probabilities notation is a way to represent real life data into a math language that can then be manipulated to extract new findings. Just like all Maths. One should be aware of it, and use in real-life applications when usefull.
</blockquote>
