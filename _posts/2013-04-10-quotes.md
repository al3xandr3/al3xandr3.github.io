...
> "2015-10-23"
Mini job attitude manifesto: Keep a little bit the outsider standalone "do it all" attitude. Try first do it 'the right way', ignore a little bit the local culture how-to if it looks wrong, but don't dismiss it completely. Do look at other people's code. Thrive to learn more ! Learning is needed a component of the job. Have fun !
...
> "2012-01-10"Sharing data, in an agreed upon format, is an incentive for re-use and disincentive for wasteful duplication. #semanticweb
