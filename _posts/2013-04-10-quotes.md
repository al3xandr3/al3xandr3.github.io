...
It gets weaker if not exercised.
Even when away from "normal" work job, schedule in some time for it, does not need to take all the time, just a couple of hours per day.
