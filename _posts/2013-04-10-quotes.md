...
Defaults Matter, the way you setup your environment, the tools you use, the company / village culture, matter immensily to the way you end up doing things and consequently impacts the end result. If all you have is  the wrong screwdrivers, people saying it can't be done and getting in the way, the job is not going to be as clean and well done.

Think about defaults, and workflows and make them incentives in right direction.
...
Job attitude manifesto

Keep a little bit the outsider standalone "do it all" attitude. Try first do it 'the right way', ignore a little bit the local culture how-to if it looks wrong, but don't dismiss it completely. 

Do look at other people's code. 

Thrive to learn more ! Learning is needed a component of the job. 
...
Everything you do, read and write on the web will be tracked, and that will be your unique fingerprint. The way you write (using text analysis) and all your browsing habits, uniquely define your identity. That will be the new unique global identity.


> "2015-10-04"

Probabilities notation is a way to represent real life data into a math language that can then be manipulated to extract new findings. Just like all Maths. One should be aware of it, and use in real-life applications when useful.
...
In upper management there's a lot of turf wars and politics, is not only about the actually hability for the job.

In fact, in upper management politics are a need hability to have, besides the "normal" job habilities.
...
> "2012-06-27"is node.js the new rails? aka "the" platform for agile web dev. javascript has advantage, most widespread language interpreter(ever)? - the browser
...
> "2011-12-10"should use natural evolution learnings in digital world: version 1.0 is rarely any good, most things wont work failfast, competition matters 

> "2011-12-10"natural evolution is more than just a bit of textbook we have to memorize in school it actually shows up again and again

> "2011-12-10"so many technologies came, go, change and evolve... is like watching a fast forward natural evolution of the digital world

> "2011-12-08"speed not always better, an iphone game is better released earlier than later but i wont hurry up the design of #ruby, good things take time

> "2011-12-08"how fast is an #agile snail? Faster than a non-agile snail but not as fast as the naturally agile hummingbird #tools

> "2011-12-07"the 2012 reviewed edition of the 9 Unix precepts adds: #10 REST API(on Cloud) is the new shell & #11 JSON is the new plain text. 1st 9 <a href='http://bit.ly/9JS5CY'>http://bit.ly/9JS5CY</a>

> "2011-10-22"scalability demands decoupling
...
> "2011-03-17"Adaptive Web Sites http://bit.ly/dHwDbQ, thats the right direction and in fact applies to all Human–devices interactions http://bit.ly/g8PUdC
...
> "2011-02-21"RT @patio11 Minor heresy: "Reverse a linked list" doesn't test ability, it tests for cultural fit in a programming community which likes pointers.
...
> "2011-02-15"working on a web analytics tracking javascript api today, thriving for simpler, smaller, more flexible api w/ a bit of functional magic
...
> "2010-08-17"AB testing productivity, going on a information diet: no rss feeds, less of twitter, more of emacs. (Rescue)Time will tell.


> "2010-04-15"new blog: http://al3xandr3.github.com/ is a better platform for writing longer texts, i can easily reach all the text I've ever written, and all edit history is saved.


## 2009

> "2009-11-13"Functional: Here's a few articles by Slava (on www.defmacro.org) that i enjoyed reading:.. <a href='http://bit.ly/2OpTe0'>http://bit.ly/2OpTe0</a>

> "2009-07-24"simpler, lighter, faster, cleaner, cheaper, leaner, lesser. 
...
> "2009-07-20"On cat ownership: be sure to pay attention to what your cat brings back into the house. You might find yourself with a couple of new pets.

> "2009-04-22"Today marks the day where I've done my first Clojure macro! Not just as an exercise but for a practical reason, not the smallest macro ever either. A programming little technical accomplishment.
