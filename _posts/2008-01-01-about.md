...
### Specialties
- Product Insights, Tracking & Data Analysis
- Digital Marketing Insights, Tracking & Data Analysis
- Web Analytics
- A/B Testing
...
#### Main activities and responsibilities
- Improve company’s ability to understand and optimise its acquisition, conversion and retention campaigns by ensuring that the tracking code that underpins the web analytics, A/B testing and in-house custom tracking is configured, tested, deployed and maintained correctly.
